 ...
 *
 */
public class EmergenteETFVender extends JDialog{
	/**
	...
	public EmergenteETFVender(Ventana v,ETF o) {
		this.madre=v;
		this.etfEditar=o;
		//this.usuario=u;
		...
		campoNombre = new JTextField(this.etfEditar.getSectores());		
		...
		campoValor = new JTextField(" "+this.etfEditar.getValor());
		...
		final EmergenteETFVender thisRef=this;
		botonAceptar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					ETF.venderETF(campoNombre.getText());
